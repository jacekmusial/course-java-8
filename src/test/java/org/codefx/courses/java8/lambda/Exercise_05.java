...
public class Exercise_05 {
	...
	private Function<String, Todo> withDescripton = description -> withDescripton(description);
	private BiFunction<String, ZonedDateTime, Todo> withDescriptonAndDueDate =
			(description, due) -> withDescriptonAndDueDate(description, due);
